...
class Defeat:
    def __init__(self, window, score, battle_time):
        ...
        self.background = pygame.transform.scale(
            pygame.image.load("asset/derrota.png"),
        ...
        pygame.mixer.music.load("asset/defeat_music.wav")
    ...
    def run(self):
        while True:
            ...
            defeat_text = self.big_font.render(
                "DEFEAT",
                True,
                WHITE
            )
            ...
            self.window.blit(
                defeat_text,
                (
                    WIN_WIDTH // 2 - defeat_text.get_width() // 2,
                    90
                )
            )
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_RETURN:
                        ...
                        if self.selected == 0:
                            ...
                            save_score("Defeat", self.score, self.battle_time)
                            return "restart"
